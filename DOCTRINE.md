...
| 10 | **Sector overlays — finance, healthcare, public-sector first** | Each unlocks a vertical sales motion | 3–6 wk each | **PARTIAL 1/3 2026-06-03** — Financial Services overlay first-pass shipped as `/sector-financial-services.html`. 9 sub-modules per outline at `.audit/course-quality/sector-overlays/financial-services.md`: regulatory stack (EU AI Act + DORA + FCA + PRA + EBA + SR 11-7 + MiFID II + NYDFS) · FS-extended never-paste list (MNPI, SAR, credit-model internals, RRP, Pillar 3 pre-publication) · SR 11-7 / SS1/23 model risk management applied to AI · DORA Article 13 ICT third-party AI risk · AML / KYC AI restrictions including tipping-off offence · MiFID II Art 17 + AI Act algo trading · Consumer Duty + Section 21 customer-facing AI · parallel-regulator escalation matrix · 10-question assessment. 465-line single-page HTML. Visual differentiator: blue accent (`var(--blue)`) for sector overlays vs amber for role tracks. Wired course.html (new "Sector overlays" section), llms.txt (new section), sitemap.xml (priority 0.85). Remaining: Healthcare + Public Sector overlays (outlines exist). |
...
**Status as of 2026-06-03 (very end of day — major session)**: gates 1, 2, 3, 4 closed; gate 5 shells shipped + sourcing pack ready (finishing step user-actionable); gates 7, 9, 11, 13, 14 closed; gate 8 first-pass DONE (manual + AT pass scheduled 2026-09); gate 6 5/6 (Manager + DPO + MSP/IT-Admin + Microsoft Copilot + Shadow AI shipped today; Governance & Procurement / AI Governance Officer / Developer-Technical outlines exist); gate 10 1/3 (Financial Services overlay shipped today; Healthcare + Public Sector outlines exist); gate 12 PARTIAL (recipe ready, purchase blocked on user financial action). Only gate 15 (CPD accreditation — external multi-month) remains genuinely off-roadmap. Strong position for first MSP-partner activation across the full content estate: 5 role tracks + 1 sector overlay + 6 templates + 30-day rollout guide + SCORM/xAPI export + EU-locale shells + first-pass WCAG conformance. RORtech-equivalents can self-serve any of: M365 governance customer, FS customer, MSP-internal-staff Article 4 obligation, customer-facing shadow-AI engagement.
