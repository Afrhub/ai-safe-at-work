...
5. **Amber ink on dark paper — the Audit Dossier language.** Ruled hairlines, crop-mark corners, file tabs, clause numbering, classification chips, watermarked citations; slow layered parallax (blueprint grid + ledger rules + clause watermarks), never gradient-orb "AI SaaS" glow. Brand consistency is part of trust. (Redesigned 2026-06-11; amber palette + cinematic motion retained from v1. Typography 2026-06-11: Atkinson Hyperlegible Next / Mono site-wide for low-vision legibility — body ≥17px, no tight tracking.)
