...
> **Registrar note (corrected 2 Sep):** `attest-ai.com`'s nameservers are `domaincontrol.com`,
> which is the GoDaddy group estate 123-Reg uses — the registrar is **123-Reg** (RDAP-confirmed 2 Sep), so every DNS record in Phases 1 and 2 goes in at the **123-Reg control panel**.
