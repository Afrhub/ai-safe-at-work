...
export const BANDS = [
  { key: "1-25", pence: 99000, seats: 25, label: "Tethr Foundation, 1 to 25 staff, 12 months" },
  { key: "26-50", pence: 175000, seats: 50, label: "Tethr Foundation, 26 to 50 staff, 12 months" },
